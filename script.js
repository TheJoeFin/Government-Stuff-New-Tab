...
function loaded() {
    ...
    // let usa = divisions['ocd-division/country:us:']
    let usa = divisions[0]
    let wi = divisions['ocd-division/country:us/state:wi:']
    let wi2 = divisions['ocd-division/country:us/state:wi/cd:4:']
    let county = divisions['ocd-division/country:us/state:wi/county:milwaukee:']
    let city = divisions['ocd-division/country:us/state:wi/place:milwaukee:']
    ...
    for (let index = 0; index < officials.length; index++) {
        const element = officials[index]
        const office = offices[index]
        listParentDiv.innerHTML += `
            <li>${office.name}</li>
            <li><h3>${element.name}<h3> <a href=${element.urls} >Website</a> </li>
        `
    }
}
